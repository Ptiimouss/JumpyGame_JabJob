...
public class AISenseSight : AISense<SightStimulus>
{
    ...
    [SerializeField] AudioSource sonMouton;
    public float ConeAccuracy = 0.5f;
     //On ne teste pas la largeur totale du mesh, on lui laisse une marge 
    ...
    protected override bool doSense(Transform obj, ref SightStimulus sti)
    {
        ...
        float width = Mathf.Max(b.extents.x, b.extents.z);
