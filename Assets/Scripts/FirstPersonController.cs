...
public class FirstPersonController : MonoBehaviour
{
    ...
    public static Vector3 lastCheckPointPos = new Vector3(-35, 6, -40);
    public static Quaternion lastCheckPointRot;
    // Spawn new Vector3(-35, 6, -40);
    // CP 1 new Vector3(-19, 9, 5);
    // CP 2 new Vector3(9, 11, 66);
    // CP 3 new Vector3(68, 37, 90);
    // CP 4 new Vector3(85.5f, 43, -2);
    // CP 5 new Vector3(60, 64, 43);
    ...
    public Vector3 bobAmount = new Vector3(0f, .05f, 0f);
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            {
                NoiseStatus.instance.NoiseLevel = 2;
            ...
            {
                isSprinting = false;
                NoiseStatus.instance.NoiseLevel = 1;
    ...
    private void Crouch()
    {
        ...
        {
            NoiseStatus.instance.NoiseLevel = 0;
    ...
    {
        if (/*other.gameObject.CompareTag("Respawn") || */other.gameObject.CompareTag("Destroy"))
        {
            Scene scene = SceneManager.GetActiveScene();
            SceneManager.LoadScene(scene.name);
        }
